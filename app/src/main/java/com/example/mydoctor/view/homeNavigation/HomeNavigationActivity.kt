package com.example.mydoctor.view.homeNavigation
...
import com.example.mydoctor.databinding.ActivityHomeNavigationBinding
...
class HomeNavigationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val appBarConfiguration = AppBarConfiguration(
            setOf(R.id.navigation_doctor, R.id.navigation_hospitals, R.id.navigation_messages)
        )
